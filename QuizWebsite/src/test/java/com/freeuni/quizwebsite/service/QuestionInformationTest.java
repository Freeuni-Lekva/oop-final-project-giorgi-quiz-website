...
class QuestionInformationTest {
    ...
    void getQuestionTest() throws SQLException {
        ...
        Question question1Desired = new Question(1, "Ra hqvia Giorgis?", QuestionType.QUESTION_RESPONSE, 1);
        assertEquals(question1, question1Desired);

        Question question2 = QuestionInformation.getQuestion(2);
        assert question2 != null;
        Question question2Desired = new Question(2, "Vin misca kalata witelqudas?", QuestionType.MULTIPLE_CHOICE, 1);
        assertEquals(question2, question2Desired);
    }

    @Test
    void getQuestionsInQuizTest() throws SQLException {
        Question question1 = new Question(1, "Ra hqvia Giorgis?", QuestionType.QUESTION_RESPONSE, 1);
        Question question2 = new Question(2, "Vin misca kalata witelqudas?", QuestionType.MULTIPLE_CHOICE, 1);
